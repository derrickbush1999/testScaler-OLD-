 ...
 * @author derri
 */
public class TSRemoveClass extends javax.swing.JFrame {

    /**
     * Creates new form TSRemoveClass
     */
    public TSRemoveClass() {
        initComponents();
    }
    ...
    public void tableFill()
    {
        ...
        names = classinfo.classesToArray();
    ...
    private void initComponents() {
        ...
        ClassNumberLabel.setText("Class Number:");
    ...
    private void ClassNumberTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClassNumberTextActionPerformed
        ...
        Class classinfo = new Class();
        classinfo.DeleteClass(Integer.parseInt(ClassNumberText.getText())-1);
        tableClear();
        tableFill();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TSRemoveClass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TSRemoveClass().setVisible(true);
            }
        });
    }
