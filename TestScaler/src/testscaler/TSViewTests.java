 ...
 * @author derri
 */
public class TSViewTests extends javax.swing.JFrame {

    /**
     * Creates new form TSViewTests
     */
    public TSViewTests() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ClassSizeLablel.setText("Test number:");
    ...
    private void NextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextButtonActionPerformed
        ...
        new TSViewTestsTests(hold).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TSViewTests.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TSViewTests().setVisible(true);
            }
        });
    }
